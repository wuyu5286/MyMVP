...
import com.jumeng.shop.okhttp.ImageUtils;
import com.jumeng.shop.okhttp.callback.ResultCallback;
...
public class OkHttpDisplayImgRequest extends OkHttpGetRequest {
    ...
    protected OkHttpDisplayImgRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, ImageView imageView, int errorResId) {
